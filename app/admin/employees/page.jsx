...
const roles = ['stylist', 'barber', 'beautician', 'receptionist', 'admin'];
const emptyForm = {
  username: '',
  full_name: '',
  salon_role: 'stylist',
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">Salon roles, access PINs, service revenue, and commission summaries.</p>
            </div>
              ...
              <tbody className="divide-y divide-gray-100">
                {filteredStaff.map((employee) => (
                  <tr key={employee.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-5 py-4 capitalize text-gray-700">{employee.salon_role}</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white">
            ...
            <form onSubmit={handleSubmit} className="grid gap-4 p-6 md:grid-cols-2">
              ...
              <label className="block">
                <span className="mb-2 block text-sm font-medium text-gray-900">Salon role *</span>
              ...
              <label className="block">
                ...
                <div className="relative">
                  ...
                  <input type="password" maxLength={4} required={!editingStaff} value={formData.pin} onChange={(event) => setFormData({ ...formData, pin: event.target.value })} className="w-full rounded-lg border border-gray-300 py-3 pl-10 pr-4 text-gray-950 outline-none focus:ring-2 focus:ring-gray-900" placeholder="4 digits" />
                </div>
              </label>
              <label className="block">
